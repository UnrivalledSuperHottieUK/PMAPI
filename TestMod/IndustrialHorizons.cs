...
namespace IndustrialHorizons
{
    public class IndustrialHorizons : MelonMod
    {
        ...
        public override void OnInitializeMelon()
        {
            ...
            CubeMerge.compoundablePairs.Add(new Il2CppSystem.ValueTuple<Substance, Substance>(this.chromium, this.steel), new Il2CppSystem.ValueTuple<float, Substance, float>(0.2f, this.stainlesssteel, 1f));
        ...
        private void RegisterCoal()
		{
			...
			{
				name = "Coal (C)",
				color = new Color(0.2f, 0.1f, 0.1f)
			};
			...
			param.density = 0.9f;
			param.combustionHeat = 14000f;
            param.kindlingPoint = 600f;
			param.combustionSpeed = 1E-04f;
